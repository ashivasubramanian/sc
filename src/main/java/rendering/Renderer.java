 ...
 * <ol>
 * <li>Calculation - Performs any game calculation and stores its results. It
 * also holds getter, and if required, setter methods to the results.</li>
 * <li>Renderer - This layer has instances of all the objects that are shown to
 * the user. It uses these instances to invoke methods that display the
 * graphical equivalent of the data in the Calculation layer.</li>
...
/**
 * The Renderer class is the only class in the Renderer layer. It holds
 * instances of the objects which the user can see, as well as instances of the
 * classes in the Calculation layer. It uses these instances to update both the
 * layers.
 *
 * The class extends <code>Thread</code> since the job of this class is a
 * constant process.
 *
 */
public final class Renderer extends Thread {
     ...
     *
     * @param pInfoPane An instance of the <code>InfoPane</code> class. This is
     * set by <code>LoginInterface</code>.
     */
    ...
    /**
     * The run method of the class. This method constructs the
     * <code>Runnable</code> objects which are later passed on to
    ...
    /**
     * Passes the aspects for a particular station to the Calculations layer,
     * which updates itself with this data.
     *
     * @param station The station whose aspects are to be updated in the
     * Calculations layer
     * @param aspect A <code>String</code> array that contains the aspect values
     * for the station specified by <code>station</code>.
     */
